export default {
    projectLink: 'https://github.com/git-yongge/ethgo', // GitHub link in the navbar
    docsRepositoryBase: 'https://github.com/git-yongge/ethgo/tree/master/website/pages', // base URL for the docs repository
    titleSuffix: ' – Ethgo',
    nextLinks: true,
    prevLinks: true,
    search: false,
